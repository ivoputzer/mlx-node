...
describe('mlx-swift', () => {
  it('contains all keys present in the native module', () => {
  ...
  it('maintains functional parity with native methods', () => {
    const { version } = require('./package.json')
    strictEqual(mlx.version, version, 'Native method call failed through driver')
  })

  describe('mocking', () => {
    it('allows mocking methods', ({ mock }) => {
    ...
    it('has configurable property descriptors', () => {
